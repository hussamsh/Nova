...
describe("Henon map cryptography" , function() {
  ...
  describe("Encrypt test image" , () => {
    ...
    it("Encrypt Thread called and completed successfully" , (done) => {
      ...
      let encryption = new EncryptionOperation(Maps.Henon.getName() , parameters , false , inputImagePath , encryptedImagePath);
  ...
  describe("Decrypt test image" , () => {
    ...
    it("Decrypt Thread called and completed successfully" , (done) => {
      ...
      let decryption = new DecryptionOperation(Maps.Henon.getName() , parameters , false , encryptedImagePath , decryptedImagePath);
