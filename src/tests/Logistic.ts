...
describe("Logistic map cryptography" , function() {
  ...
  describe("Encrypt test image" , () => {
    ...
    it("Encrypt Thread called and completed successfully" , (done) => {
      ...
      let encryption = new EncryptionOperation(Maps.Logistic.getName() , parameters , false , inputImagePath , encryptedImagePath);
  ...
  describe("Decrypt test image" , () => {
    ...
    it("Decrypt Thread called and completed successfully" , (done) => {
      ...
      let decryption = new DecryptionOperation(Maps.Logistic.getName() , parameters , false , encryptedImagePath , decryptedImagePath);
